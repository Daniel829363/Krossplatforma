...
void Draw(StudentList* list) {
    ...
    cout.fill(' '); cout.width(147);  cout << left << "|Список студентов Политеха"; cout << "|" << endl;
    cout.width(147); cout.fill('-'); cout << "-" << endl;
    cout.fill(' ');
    cout << left << "|"; myCentr("ID", 9);
    cout << left << "|"; myCentr("Фамилия", 15);
    cout << left << "|"; myCentr("Имя", 13);
    cout << left << "|"; myCentr("Отчество", 15);
    cout << left << "|"; myCentr("Дата Рожд.", 17);
    cout << left << "|"; myCentr("Пол", 6);
    cout << left << "|"; myCentr("Факультет", 10);
    cout << left << "|"; myCentr("Кафедра", 10);
    cout << left << "|"; myCentr("Группа", 12);
    ...
    while (current != nullptr) {
        ...
        for (int i = 0; i < current->data.getCurrentSemestr(); i++) {
            ...
            string s = to_string(semester_number) + "-й семестр: ";
            for (int j = 0; j < current->data.semesters[i].counter_lessons; j++) {
...
void Draw(StudentList* list,int k) {
    ...
    cout.fill(' '); cout.width(146);  cout << left << "|Список студентов, у которых меньше 25% троект за все время: "; cout << "|" << endl;
    cout.width(147); cout.fill('-'); cout << "-" << endl;
    cout.fill(' ');
    cout << left << "|"; myCentr("ID", 9);
    cout << left << "|"; myCentr("Фамилия", 15);
    cout << left << "|"; myCentr("Имя", 10);
    cout << left << "|"; myCentr("Отчество", 15);
    cout << left << "|"; myCentr("Дата Рожд.", 18);
    cout << left << "|"; myCentr("Пол", 4);
    cout << left << "|"; myCentr("Факультет", 10);
    cout << left << "|"; myCentr("Кафедра", 10);
    cout << left << "|"; myCentr("Группа", 12);
    cout << left << "|"; myCentr("Поступил в", 8);
    cout << left << "|"; myCentr("Семестер #", 8);
    cout << " |" << endl;
    cout.width(147); cout.fill('-'); cout << "-" << endl;
    while (current != nullptr) {
        ...
        if (result < 0.25 && current->data.getDateBirthday().year >= year1 && current->data.getDateBirthday().year <= year2) {
            ...
            cout << left << "|"; cout << left << "Количество троек: " << left << current->data.getCounterOf3Mark() << left
                << " Всего оценок: " << left << current->data.getCounterOfLessons(); cout.width(139); cout << right << "|" << endl << " |" << endl;
            cout << left << "|";
            for (int i = 0; i < current->data.getCurrentSemestr(); i++) {
                cout << i + 1 << "-й семестер: ";
                for (int j = 0; j < current->data.semesters[i].counter_lessons; j++) {
